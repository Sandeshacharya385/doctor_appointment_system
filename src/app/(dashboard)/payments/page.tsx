  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-gray-100 tracking-tight">Payments</h2>
      ...
      <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4 flex items-start space-x-3">
        ...
        <div>
          <p className="text-sm font-semibold text-green-800 dark:text-green-400">Pay via WhatsApp</p>
      ...
      {appointments.length === 0 ? (
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-slate-50 dark:border-gray-800 p-16 text-center">
          <span className="material-symbols-outlined text-[56px] text-slate-300 dark:text-gray-700 mb-4 block">payments</span>
          <p className="text-slate-500 dark:text-gray-400 font-medium">No appointments to pay for</p>
          <p className="text-slate-400 dark:text-gray-500 text-sm mt-1">Book an appointment first</p>
        </div>
      ) : (
              ...
              <div key={appt.id} className="bg-white dark:bg-gray-900 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-slate-50 dark:border-gray-800 p-6">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    {/* Doctor avatar */}
                    <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold text-lg flex-shrink-0">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 mt-2 text-xs text-slate-600 dark:text-gray-400">
                  ...
                  <div className="flex flex-col items-end space-y-3">
                    ...
                    <div className="text-right">
                      <p className="text-xs text-slate-400 dark:text-gray-500">Consultation Fee</p>
                    ...
                    {canPay ? (
                      <button
                        ...
                        className="flex items-center space-x-2 bg-green-500 hover:bg-green-600 disabled:opacity-70 text-white px-4 py-2.5 rounded-xl text-sm font-bold transition-all active:scale-95 shadow-lg shadow-green-200 dark:shadow-green-900/50"
                      >
