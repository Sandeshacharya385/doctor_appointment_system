    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Welcome back, {fullName}</h1>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <div className="p-2 bg-gray-100 rounded-lg">
              <span className="material-symbols-outlined text-gray-700 text-[22px]">event_available</span>
            </div>
          </div>
          <p className="text-gray-600 text-sm">Total Appointments</p>
          <p className="text-3xl font-semibold mt-2 text-gray-900">{appointments.length}</p>
        </div>

        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <div className="p-2 bg-gray-100 rounded-lg">
              <span className="material-symbols-outlined text-gray-700 text-[22px]">today</span>
            </div>
          </div>
          <p className="text-gray-600 text-sm">Today's Appointments</p>
          <p className="text-3xl font-semibold mt-2 text-gray-900">{todayAppts.length}</p>
        </div>

        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <div className="p-2 bg-gray-100 rounded-lg">
              <span className="material-symbols-outlined text-gray-700 text-[22px]">pending_actions</span>
            </div>
          </div>
          <p className="text-gray-600 text-sm">Pending</p>
          <p className="text-3xl font-semibold mt-2 text-gray-900">{pendingAppts.length}</p>
        </div>

        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <div className="p-2 bg-gray-100 rounded-lg">
              <span className="material-symbols-outlined text-gray-700 text-[22px]">groups</span>
            </div>
          </div>
          <p className="text-gray-600 text-sm">Available Doctors</p>
          <p className="text-3xl font-semibold mt-2 text-gray-900">{doctors.length}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-lg border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <Link href="/appointments" className="text-gray-900 text-sm font-medium hover:underline">View All</Link>
          </div>
          <div className="divide-y divide-gray-200">
            {appointments.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                ...
                {user?.role === 'patient' && (
                  <Link href="/doctors" className="mt-3 text-gray-900 text-sm font-medium hover:underline">Book an appointment</Link>
                )}
              </div>
            ) : (
        ...
        <div className="space-y-6">
          ...
          {nextAppt ? (
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-sm font-semibold text-gray-900 mb-4">Next Appointment</h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{nextAppt.doctor_details?.specialization}</p>
                  </div>
                </div>
                ...
                <Link href="/appointments">
                  <button className="w-full bg-gray-900 hover:bg-gray-800 text-white py-2 rounded-lg text-sm font-medium transition-colors mt-4">
                    View Details
                  </button>
                </Link>
              </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <div className="text-center py-6">
                ...
                {user?.role === 'patient' && (
                  <Link href="/doctors">
                    <button className="mt-4 bg-gray-900 hover:bg-gray-800 text-white py-2 px-4 rounded-lg text-sm font-medium transition-colors">
                      Book Now
                    </button>
                  </Link>
                )}
